<template>
    <div class="messageIcon">
        ...
        <el-drawer class="message-el-drawer" :wrapperClosable="false" custom-id="message-el-drawer" :size="400" title=""
            v-model="drawer" direction="rtl" :before-close="handleClose">
            <div class="message-content">
                ...
                <virtual-list v-if="msgList.length" ref="virtualList" class="list" data-key="guid" :data-sources="msgList"
                    :keeps="50">
                    <template #default="{ source }">
                        <div class="message-content-item" :style="{ background: source.backgroundColor }"
                            @click="contentItemClick(source, index)">
