...
import { defineAsyncComponent, ref, watch, inject, getCurrentInstance, nextTick, toRaw } from 'vue'
import { useRouter } from 'vue-router'
const asideMenu = defineAsyncComponent(() => { return import('@/components/asideMenu/menu.vue') })
const widthSetting = defineAsyncComponent(() => { return import('gw-base-components-plus/widthSetting/widthSetting.vue') })
...
export default {
    ...
    setup (props) {
        ...
        return {
            ...
            menuSearch,
            isCollapse,
            transition, renderMenu, menus, menuActive, config, theme, showImg
        }
    },
}
