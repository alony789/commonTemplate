<template>
    <el-dialog class="editPassword" @closed="clearInput" v-model="dialogVisible" width="480px" top="28vh"
        ...
        <el-form :model="changePwd" label-position="top" :rules="rules" ref="changePasswordForm">
            <el-form-item :label="$t('login.framePro.label.originalPassword')" prop="oldPwd">
                <el-input v-model="changePwd.oldPwd" :placeholder="$t('login.framePro.tips.enterOriginPas')"
                    show-password></el-input>
            </el-form-item>
            <el-form-item :label="$t('login.framePro.label.newPassword')" prop="newPwd">
                <el-input v-model="changePwd.newPwd" :placeholder="$t('login.framePro.tips.inputNewPassword')" show-password
                    @change="pwdInputChange">
                </el-input>
            </el-form-item>
            <el-form-item :label="$t('login.framePro.label.confirmPassword')" prop="confPwd">
                <el-input v-model="changePwd.confPwd" :placeholder="$t('login.framePro.tips.enterConfirmPas')"
                    show-password></el-input>
            </el-form-item>
        </el-form>
        <template #footer>
