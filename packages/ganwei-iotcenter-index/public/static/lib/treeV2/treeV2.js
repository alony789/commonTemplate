...
})(typeof self !== 'undefined' ? self : this, function (__WEBPACK_EXTERNAL_MODULE_32__, __WEBPACK_EXTERNAL_MODULE_29__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_runtime_helpers_toConsumableArray__ = __webpack_require__(3);
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_virtualList_virtualList_vue__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__babel_runtime_helpers_toConsumableArray__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__treeNode_treeNode_vue__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_virtual_scroll_list__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__mixin_equipStatusManage__ = __webpack_require__(30);
...
/* harmony default export */ __webpack_exports__["a"] = ({
                ...
                created: function created () {
                    ...
                    if (this.showCheckbox) {
                        this.checkStatusManage = new __WEBPACK_IMPORTED_MODULE_12__mixin_checkStatusManage__["a" /* default */](this.groupNodeObject, this.nodesMap, this.equipControllObject, this.controlObject, this.equipCheckObject);
                    }
                    ...
                    // 实例化搜索管理工具
                    this.searchManage = new __WEBPACK_IMPORTED_MODULE_9__mixin_searchManage__["a" /* default */](this.groupNodeObject, this.showSettings);

                    // 实例化分组所挂载的设备数量管理工具
                    this.equipNumManage = new __WEBPACK_IMPORTED_MODULE_10__mixin_equipNumManage__["a" /* default */](this.groupNodeObject);
                ...
                methods: {
                    ...
                    init: function init () {
                        ...
                        setTimeout(function () {
                            ...
                            if (_this2.showStatus && !_this2.equipStatusManage) {
                                _this2.equipStatusManage = new __WEBPACK_IMPORTED_MODULE_7__mixin_equipStatusManage__["a" /* default */](_this2.nodesMap, _this2.equipStatusObject, _this2.groupNodeObject, _this2.statusChange);
                            }
                        }, 100);
                    },
                    ...
                    updateGroupEquips: function updateGroupEquips (key, isInit) {
                        ...
                        if (isInit) {
                            var arr = window.top["group-".concat(key)] || [];
                    ...
                    updateList: function updateList (key) {
                        ...
                        if (this.groupNodeObject[key]) {
                            ...
                            if (this.isSearchStatus) {
                                ...
                                arr = window.top["group-".concat(key)];
                                this.groupNodeObject[key].equips = __WEBPACK_IMPORTED_MODULE_2__babel_runtime_helpers_toConsumableArray___default()(__WEBPACK_IMPORTED_MODULE_6__utils_utils_js__["a" /* default */].deepClone(arr, Number(this.groupNodeObject[key].level) + 1, this.showSettings, key, this.equipCheckObject, this.equipStatusObject));
                            }
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__oparate_oparate_vue__ = __webpack_require__(25);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__treev2_vue__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tree_scss__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_10382e54_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_treev2_vue__ = __webpack_require__(44);
            var disposed = false
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1d1d4eb0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_treeNode_vue__ = __webpack_require__(27);
            var disposed = false
            var normalizeComponent = __webpack_require__(2)
            /* script */
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1824beb2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_oparate_vue__ = __webpack_require__(26);
            var disposed = false
            var normalizeComponent = __webpack_require__(2)
            /* script */
...
/***/ (function (module, exports, __webpack_require__) {
            ...
            (function (global, factory) {
                true ? module.exports = factory(__webpack_require__(29)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__equipProcessing_gwSignalr_js__ = __webpack_require__(31);



            var equipStatusManage = /*#__PURE__*/function () {
                function equipStatusManage (nodesMap, equipStatusObject, groupNodeObject, statusChange) {
                ...
                __WEBPACK_IMPORTED_MODULE_1__babel_runtime_helpers_createClass___default()(equipStatusManage, [{
                    ...
                    value: function updateByGroup (key) {
                        ...
                        if (!this.aleadyUpdateStatus[key]) {
                            var list = window.top["group-".concat(key)] || [];
                            if (list.length) {
                    ...
                    value: function setStatus (data) {
                        ...
                        var groupId = window.top.equipCache[data.equipNo] && window.top.equipCache[data.equipNo].groupId;
                            ...
                            return __WEBPACK_IMPORTED_MODULE_3__babel_runtime_regenerator___default.a.wrap(function _callee$ (_context) {
                                while (1) switch (_context.prev = _context.next) {
                                    case 0:
                                        _context.prev = 0;
                                        _context.next = 3;
                                        return this.signalr.invoke(this.connectionId, this.equipNo);
                                    case 3:
                                        _context.next = 8;
                                        break;
                                    case 5:
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_utils__ = __webpack_require__(8);
            ...
            var searchManage = /*#__PURE__*/function () {
                // 分组节点扁平化对象、设备扁平化对象、window缓存设备扁平化对象
                function searchManage (groupNodeObject, showSettings) {
                ...
                __WEBPACK_IMPORTED_MODULE_1__babel_runtime_helpers_createClass___default()(searchManage, [{
                    ...
                    value: function updateBySearch (item, searchName) {
                        var arr = window.top["group-".concat(this.groupNodeObject[item].key)];
                        if (arr) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__babel_runtime_helpers_createClass__);
            ...
            var equipNumManage = /*#__PURE__*/function () {
                // 分组节点扁平化对象、设备扁平化对象、window缓存设备扁平化对象
                function equipNumManage (groupNodeObject) {
                ...
                __WEBPACK_IMPORTED_MODULE_1__babel_runtime_helpers_createClass___default()(equipNumManage, [{
                    ...
                    value: function getAllEquipsNum () {
                        var total = 0;
                        for (var item in this.groupNodeObject) {
                            if (window.top["group-".concat(this.groupNodeObject[item].key)]) {
                                total = total + window.top["group-".concat(this.groupNodeObject[item].key)].length;
                            }
                        }
                        return total;
                    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__babel_runtime_helpers_createClass__);
            ...
            var checkStatusManage = /*#__PURE__*/function () {
                function checkStatusManage (groupNodeObject, nodesMap, equipControllObject, controlObject, equipCheckObject) {
                    ...
                    value: function updateCheckedStatusWithEquips (list) {
                        ...
                        window.setTimeout(function () {
                            for (var index = 0, length = list.length; index < length; index++) {
                                // 从缓存中看有没有该设备，防止是脏数据
                                var data = window.top.equipCache[list[index]];
                    ...
                    value: function updateCheckedStatusWithControls (list) {
                        ...
                        window.setTimeout(function () {
                            ...
                            for (var index = 0, length = list.length; index < length; index++) {
                                ...
                                if (window.top.equipCache[equipNo]) {
                    ...
                    value: function updateGroupSelect (list, checked) {
                        ...
                        list.forEach(function (item) {
                            if (_this14.groupNodeObject[item]) {
                                ...
                                var _list = window.top["group-".concat(item)] || [];
