            ...
            if (JSON.stringify(this.query) == '{}') {
                ...
                if (this.urlConfig.method == 'redirect') {
                    ...
                    if (window.top.location.search) {
                        let str = window.top.location.origin + window.top.location.pathname + window.top.location.hash + window.top.location.search
                        window.top.location.href = str;
                    } else {
                        window.top.location.href = this.urlConfig.api;
                    }
                } else {
